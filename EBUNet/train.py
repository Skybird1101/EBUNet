...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="EBUNet", help="model name: Context Guided Network (CGNet)")
    ...
    parser.add_argument('--input_size', type=str, default="720,960", help="input size of model")
